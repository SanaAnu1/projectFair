...
function Footer() {
  return (
    <div> <div className='d-flex justify-content-center align-items-center flex-column text-light mt-5 p-4 py-5' style={{width:"100%",backgroundColor:'#7ccc7c'}}>
    ...
    <div className='pt-3 text-dark'>Copyright @ 2024 Daily Cart. Built with React</div>
  </div></div>
  )
}
